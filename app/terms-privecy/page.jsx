...
export default function TermsPrivacy() {
  return (
    <div className="min-h-screen bg-gray-50 p-8 md:p-16 flex flex-col items-center">
      ...
      {/* Contact Info */}
      <section className="flex flex-col sm:flex-row gap-6 justify-center max-w-3xl mb-16">
        <a
          href="tel:+963991566773"
          className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition transform hover:scale-105 text-center"
        >
          Call Us
        </a>
        <a
          ...
          target="_blank"
          className="bg-green-600 text-white px-6 py-3 rounded-xl hover:bg-green-700 transition transform hover:scale-105 text-center"
        >
          WhatsApp
        </a>
        <a
          ...
          target="_blank"
          className="bg-sky-500 text-white px-6 py-3 rounded-xl hover:bg-sky-600 transition transform hover:scale-105 text-center"
        >
          Telegram
        </a>
      </section>
